...
{
    public partial class InterpostLabel : DevExpress.XtraReports.UI.LightSwitchReport
    {
        public InterpostLabel()
        {
            InitializeComponent();
        }

        private void InterpostLabel_DataSourceDemanded(object sender, EventArgs e)
        {
